...
// Call this to bind for push notifications. Content of [options] depends on whether we are working with APNS (iOS) or GCM (Android)
PushNotification.prototype.bindDevice = function(successCallback, errorCallback, options) {
    ...
    cordova.exec(successCallback, errorCallback, "PushPlugin", "bindDevice", []);
};
